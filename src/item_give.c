...
GetItemEntry sGetItemTable_ap[] = {
    ...
    GET_ITEM(ITEM_RECOVERY_HEART, OBJECT_GI_HEART, GID_RECOVERY_HEART, 0x45, GIFIELD(GIFIELD_NO_COLLECTIBLE, 0),
             CHEST_ANIM_LONG),
    // GI_46
    GET_ITEM(ITEM_DEED_LAND, OBJECT_GI_BOTTLE_04, GID_SF_WOODFALL, 0x46, GIFIELD(GIFIELD_NO_COLLECTIBLE, 0), CHEST_ANIM_SHORT),
    // GI_47
    GET_ITEM(ITEM_DEED_LAND, OBJECT_GI_BOTTLE_04, GID_SF_SNOWHEAD, 0x47, GIFIELD(GIFIELD_NO_COLLECTIBLE, 0), CHEST_ANIM_SHORT),
    // GI_48
    GET_ITEM(ITEM_DEED_LAND, OBJECT_GI_BOTTLE_04, GID_SF_GREATBAY, 0x48, GIFIELD(GIFIELD_NO_COLLECTIBLE, 0), CHEST_ANIM_SHORT),
    // GI_49
    GET_ITEM(ITEM_DEED_LAND, OBJECT_GI_BOTTLE_04, GID_SF_STONETOWER, 0x49, GIFIELD(GIFIELD_NO_COLLECTIBLE, 0), CHEST_ANIM_SHORT),
    // GI_4A
...
RECOMP_PATCH u8 Item_Give(PlayState* play, u8 item) {
    ...
    if (item == ITEM_DEKU_STICK) {
        ...
        SET_EQUIP_VALUE(EQUIP_TYPE_SHIELD, MIN(rando_has_item(GI_SHIELD_HERO), EQUIP_VALUE_SHIELD_MIRROR));
